...
public class FP08OpertionsWithCustomClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("==========allMatch, noneMatch, anyMatch on review Score============");
		...
		System.out.println("==========allMatch, noneMatch, anyMatch on no Of Students============");
		
		Predicate<Course> noOfStudentsgreaterThan21K = course->course.getNoOfStudents()>21000;
		
		List<Course> noOfStudentsGreaterThan21KSt = courses.stream().filter(noOfStudentsgreaterThan21K).collect(Collectors.toList());
		
		System.out.println(noOfStudentsGreaterThan21KSt);
		
		System.out.println(courses.stream().anyMatch(noOfStudentsgreaterThan21K));//True
		...
		Map<String, Long> t = courses.stream()
		.collect(Collectors.groupingBy(Course::getCategory, Collectors.counting()));
		
		
		Map<String, Optional<Course>> tt = courses.stream()
		.collect(Collectors.groupingBy(Course::getCategory, 
